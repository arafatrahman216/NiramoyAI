        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-2xl font-bold text-blue-400 mb-4">NiramoyAI</h3>
              <p className="text-gray-400 mb-6 leading-relaxed">
                Your trusted healthcare companion. We connect you with verified doctors, 
                accredited test centers, and provide AI-powered health assistance to make 
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 NiramoyAI. All rights reserved.
            </p>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-400 mb-6">
                You need to sign up and log in to access the AI Assistant and other personalized features.
              </p>
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex-1 py-3 border border-gray-600 hover:border-gray-500 text-gray-300 hover:text-white rounded-lg font-semibold transition-colors"
                  onClick={() => {
                    setShowAuthModal(false);
                    navigate('/login');
                  }}
