            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 border border-zinc-600 hover:border-zinc-500 text-zinc-300 hover:text-white rounded-lg font-semibold transition-colors"
      ...
      <section className="relative -mt-16 z-30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="bg-zinc-900 border border-zinc-700 rounded-2xl p-8 backdrop-blur-lg bg-opacity-95 shadow-2xl"
          >
            ...
            {searchType === 'symptoms' ? (
              <div className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-semibold transition-colors disabled:opacity-50"
