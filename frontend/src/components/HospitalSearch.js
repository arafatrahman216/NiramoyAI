  ...
  <div className="mt-10">
    {hospitals.length === 0 ? (
      ...
      >
        ...
        <h3 className="text-white text-lg font-semibold mb-2">No hospitals found</h3>
        <p className="text-zinc-500 text-sm max-w-md">
          Try another hospital name or explore nearby locations to discover more healthcare providers.
        </p>
      </motion.div>
    ) : (
      <>
            ...
            >
              ...
              <div className="relative">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <span className="text-xs text-zinc-500 bg-zinc-800/80 px-2 py-1 rounded-full">Profile</span>
                </div>
                ...
                <div className="mt-6 flex justify-between items-center">
                  <span className="text-xs uppercase tracking-wide text-zinc-500">Verified hospital listing</span>
                  <a
